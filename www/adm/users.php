...
$asked = (int) ($_REQUEST['asked'] ?? 0);
$beer = (int) ($_REQUEST['beer'] ?? 0);
$elite = (int) ($_REQUEST['elite'] ?? 0);
$brother = (int) ($_REQUEST['brother'] ?? 0);
$talk = (int) ($_REQUEST['talk'] ?? 0);
$achievement_id = (int) ($_REQUEST['achievement_id'] ?? 0);
...
foreach ($result as $row) {
  $accounts = (int) ($userlogins[$row['id']] ?? 0);
