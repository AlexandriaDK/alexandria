...
// Ensure $gamelist is always defined, even when there are no games
$gamelist = [];
  ...
  if (!isset($gamelist[$sid])) {
    $gamelist[$sid] = [
      'game' => [
        ...
        // Robust tag decoding: ensure array of unique string tags
        'tags' => (function ($json) {
          $arr = json_decode($json, true);
          if (!is_array($arr)) {
            $arr = [];
          }
          // Filter out nulls and ensure scalar strings
