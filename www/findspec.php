...
$filelanguages = getall("SELECT COUNT(DISTINCT game_id) AS count, language FROM files WHERE language != '' AND downloadable = 1 GROUP BY language ORDER BY count DESC", FALSE);
