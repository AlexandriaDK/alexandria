...
<head>
    ...
    <style>
        ...
        .status { background: #e8f5e8; border: 1px solid #4caf50; padding: 10px; border-radius: 5px; margin: 20px 0; }
        .info { background: #f0f8ff; border: 1px solid #0066cc; padding: 10px; border-radius: 5px; margin: 20px 0; }
