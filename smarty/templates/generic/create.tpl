  ...
  {else}
    ...
    <form action="adm/user_creategame.php" method="post">
      <table id="createtable">
        ...
        <tr>
          <td><span id="text_authors">{$_create_input_authors_organizers}</span><span id="text_designers"
              style="display: none;">{$_create_input_designers}</span></td>
        ...
        <tr>
          ...
          <td><input type="text" name="rundescription" style="width: 200px"
              placeholder="{$_create_input_runlanguage_placeholder|escape}"></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><textarea name="notes" placeholder="{$_create_input_other_placeholder|escape}"
              style="width: 500px; height: 100px"></textarea></td>
        </tr>
        <tr>
