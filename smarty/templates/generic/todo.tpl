    ...
    <div id="tabslist" class="tabsmin">
      <ul>
        {foreach $cons_list as $cc => $country}
          <li><a href="#tabslist-{$cc}" title="{$country.countryname|escape}">{$country.countryname|escape}
              ({$country.cons|count})</a></li>
        {/foreach}
      </ul>
    ...
    <div id="tabsguide" class="tabsmin">
      <ul>
        {foreach $cons_content as $cc => $country}
          <li><a href="#tabsguide-{$cc}" title="{$country.countryname|escape}">{$country.countryname|escape}
              ({$country.cons|count})</a></li>
        {/foreach}
      </ul>
    ...
    <div id="tabsmissing" class="tabsmin">
      <ul>
        {foreach $cons_missing as $cc => $country}
          <li><a href="#tabsmissing-{$cc}" title="{$country.countryname|escape}">{$country.countryname|escape}
              ({$country.cons|count})</a></li>
        {/foreach}
      </ul>
