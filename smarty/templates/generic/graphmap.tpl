...
<div id="contentwide">
  ...
  <form style="margin-top: 3em;" action="" method="get" onsubmit="return getAuthorGraph();">Indtast forfatter: <input
      type="text" name="authorinput" id="authorinput" class="tags" value="{$name|escape}" />
  </form>

  <p>Forfattere i grafen: <span id="authorcount">0</span> <span id="authoraddition"
